...
class CreatureAbilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create creature_ability" do
    assert_difference("CreatureAbility.count") do
      post creature_abilities_url, params: { creature_ability: { ability_id: @creature_ability.ability_id, cooldown_rounds: @creature_ability.cooldown_rounds, creature_id: @creature_ability.creature_id, notes: @creature_ability.notes, usage_limit: @creature_ability.usage_limit } }
    end
